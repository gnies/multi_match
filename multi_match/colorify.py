...
### Code taken from https://raw.githubusercontent.com/guiwitz/microfilm/master/microfilm/colorify.py

### This code can be used under the conditions of the BSD 3-Clause License
